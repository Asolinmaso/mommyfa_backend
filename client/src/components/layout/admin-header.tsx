      ...
      {isMobileMenuOpen && (
        <div className="md:hidden border-t border-primary-foreground/10">
          <div className="container mx-auto px-4 py-3 space-y-1">
            <Button variant="ghost" className="w-full justify-start text-sm font-medium text-white hover:bg-primary-foreground/10" onClick={() => navigateTo('/admin')}>
              <LayoutDashboard className="mr-2 h-4 w-4" />
              Dashboard
            </Button>
            <Button variant="ghost" className="w-full justify-start text-sm font-medium text-white hover:bg-primary-foreground/10" onClick={() => navigateTo('/admin/products')}>
              <Package className="mr-2 h-4 w-4" />
              Products
            </Button>
            <Button variant="ghost" className="w-full justify-start text-sm font-medium text-white hover:bg-primary-foreground/10" onClick={() => navigateTo('/admin/categories')}>
              <LayoutGrid className="mr-2 h-4 w-4" />
              Categories
            </Button>
            <Button variant="ghost" className="w-full justify-start text-sm font-medium text-white hover:bg-primary-foreground/10" onClick={() => navigateTo('/admin/orders')}>
              <ShoppingBag className="mr-2 h-4 w-4" />
              Orders
            </Button>
            <Button variant="ghost" className="w-full justify-start text-sm font-medium text-white hover:bg-primary-foreground/10" onClick={() => navigateTo('/admin/users')}>
              <Users className="mr-2 h-4 w-4" />
              Users
            </Button>
            <Button variant="ghost" className="w-full justify-start text-sm font-medium text-white hover:bg-primary-foreground/10" onClick={() => navigateTo('/admin/content')}>
              <BookOpen className="mr-2 h-4 w-4" />
              Content
            </Button>
            <Button variant="ghost" className="w-full justify-start text-sm font-medium text-white hover:bg-primary-foreground/10" onClick={() => navigateTo('/admin/analytics')}>
              <BarChart3 className="mr-2 h-4 w-4" />
              Analytics
            </Button>
          </div>
