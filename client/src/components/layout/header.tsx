      ...
      <div className="container mx-auto px-4 py-2">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center">
            ...
            <Link href="#" className="flex items-center mx-2 header-button rounded-full px-3 py-1" aria-label="Wishlist">
            ...
            <Link href="#" className="flex items-center mx-2 header-button rounded-full px-3 py-1 relative" aria-label="Shopping Cart">
              <ShoppingCart className="h-5 w-5" />
              <span className="absolute -top-2 -right-2 bg-accent text-amber-800 text-xs rounded-full h-5 w-5 flex items-center justify-center font-bold">0</span>
            </Link>
            ...
            <div className="ml-2">
              ...
              <div id="google_translate_element" className="hidden mt-2"></div> {/* Add margin for better spacing */}
            </div>
          </div>
        </div>
