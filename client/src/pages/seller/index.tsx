...
import { Package, ShoppingBag, Users, BarChart3, Truck, CreditCard, PlusCircle } from 'lucide-react';
...
const SellerDashboard = () => {
  ...
  const totalSales = 12560;
  const totalOrders = 28;
  const pendingOrders = 5;
  const totalCustomers = 16;
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {products.filter(p => p.stock < 10).length} products low in stock
                </p>
              </CardContent>
            </Card>
