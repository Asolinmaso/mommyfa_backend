...
export interface IStorage {
  ...
  updateHeroSlider(id: number, heroSlider: Partial<InsertHeroSlider>): Promise<HeroSlider | undefined>;
  deleteHeroSlider(id: number): Promise<boolean>;
  getAllHeroSliders(): Promise<HeroSlider[]>;
  getActiveHeroSliders(): Promise<HeroSlider[]>;

  // PromoAd operations
  getPromoAd(id: number): Promise<PromoAd | undefined>;
  createPromoAd(promoAd: InsertPromoAd): Promise<PromoAd>;
  updatePromoAd(id: number, promoAd: Partial<InsertPromoAd>): Promise<PromoAd | undefined>;
  deletePromoAd(id: number): Promise<boolean>;
  ...
  getWishlistsByUser(userId: number): Promise<Wishlist[]>;
